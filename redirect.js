// @ts-check
/// <reference types="../types/Lampa.d.ts" />
    ...
    function startMe() {
        ...
        Lampa.SettingsApi.addParam({
            ...
            onChange: function (value) {
                ...
                // Corrected comparison: check if value is not an empty string
                if (value !== '') {
                    startMe();
                }
            },
        ...
        Lampa.Keypad.listener.follow('keydown', function (e) {
            // Use e.key for modern browsers, fallback to e.code if needed
            // Note: Keypad codes might differ, adjust as necessary. Assuming standard 'ArrowDown' for key code 40.
            if (e.key === 'ArrowDown' || e.code === 'ArrowDown' || e.code === '29461') {
                Lampa.Storage.set('const_redirect', false);
            }
        });

        setTimeout(function () {
            // Use Lampa.Storage.get to retrieve the value for comparison
